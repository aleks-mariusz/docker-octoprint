...
ARG OCTOPRINT_PLUGIN_FANSPEEDSLIDER_VERSION=master
...
RUN pip --version \
    ...
    && pip install https://github.com/DimchikUA/OctoPrint-FanSpeedSlider/archive/$OCTOPRINT_PLUGIN_FANSPEEDSLIDER_VERSION.zip \
